    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your trusted partner for tax and compliance services. We help businesses and individuals navigate the complex regulatory landscape.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a 
                  href="https://www.instagram.com/mykarsahayak" 
                  target="_blank" 
              ...
              <li>
                <a 
                  href="https://whatsapp.com/channel/0029VajJW065q08gOrPsNg04" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center text-gray-400 hover:text-white transition"
                >
                  <span className="mr-2">🔹</span>
                  <span className="mr-2">WhatsApp Channel</span>
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a 
                  href="https://twitter.com/mykarsahayak" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center text-gray-400 hover:text-white transition"
                >
              ...
              <li>
                <a 
                  href="https://www.facebook.com/people/My-Kar-Sahayak/61559292830202" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center text-gray-400 hover:text-white transition"
                >
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} MyKS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
