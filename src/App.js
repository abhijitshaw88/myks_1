    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center whatsapp" title="WhatsApp us">
        <a
          ...
          className="flex items-center justify-center bg-[#25d366] hover:bg-[#1ebe57] rounded-full shadow-lg transition p-1"
          aria-label="WhatsApp us"
        >
          <svg style={{ display: 'block', height: 40, width: 40 }} width="40" height="40" viewBox="0 0 1219.547 1225.016">
