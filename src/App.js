...
import nitishImg from './assets/nitish_sharma.jpg'; // adjust path if needed
import amitImg from './assets/amit_jha.jpg'; // adjust path if needed
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
                Your Trusted Partner in <span className="text-blue-600">Tax Solutions</span>
              </h1>
              <p className="text-lg text-gray-600 mb-8">
                Experience hassle-free tax filing with our expert team. We provide comprehensive tax solutions for individuals and businesses, ensuring compliance and maximizing savings.
              </p>
            ...
            <div className="md:w-1/2">
              <img 
                src="/images/tax-illustration.svg" 
                alt="Tax Solutions" 
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We combine expertise with technology to deliver exceptional tax services. Our commitment to excellence and client satisfaction sets us apart.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition text-center">
              ...
              <p className="text-gray-600">Qualified professionals with extensive experience in tax and compliance matters.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition text-center">
              ...
              <p className="text-gray-600">We ensure all deadlines are met with precision and efficiency.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition text-center">
              ...
              <p className="text-gray-600">Competitive pricing with no hidden charges or surprises.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
              <img src={nitishImg} alt="Team Member" className="w-full h-64 object-cover" />
              <div className="p-6">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition">
                <img src={amitImg} alt="Team Member" className="w-full h-64 object-cover" />
              <div className="p-6">
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-6">
                ...
                <Link to="/" className="text-xl font-bold">myKar<span className="text-blue-400">Sahayak</span></Link>
              </div>
              <p className="text-gray-400 mb-4">Simplifying tax compliance for individuals and businesses with expert services.</p>
              <div className="flex space-x-4">
                <a href="https://facebook.com/mykarsahayak" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                  </svg>
                </a>
                <a href="https://instagram.com/mykarsahayak" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://twitter.com/mykarsahayak" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/services#itr" className="text-gray-400 hover:text-white transition">ITR e-filing</Link></li>
                <li><Link to="/services#gst" className="text-gray-400 hover:text-white transition">GST e-filing</Link></li>
                <li><Link to="/services#tds" className="text-gray-400 hover:text-white transition">TDS Compliances</Link></li>
                <li><Link to="/services#misc" className="text-gray-400 hover:text-white transition">Miscellaneous Services</Link></li>
          ...
          <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0">&copy; {new Date().getFullYear()} myKarSahayak. All rights reserved.</p>
            <div className="flex space-x-6">
              ...
              <Link to="/sitemap" className="text-gray-400 hover:text-white transition">Sitemap</Link>
            </div>
          </div>
        </div>
      </footer>
