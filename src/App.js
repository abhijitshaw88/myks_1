  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center whatsapp" title="WhatsApp us">
        <a
          href="https://wa.me/917605843136?text=Hello, I would like to know more about myKarSahayak services. https://myks.co.in Please share some more details."
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center bg-[#25d366] hover:bg-[#1ebe57] rounded-full shadow-lg transition p-2"
          aria-label="WhatsApp us"
        >
          <svg style={{ display: 'block', height: 60, width: 60 }} width="60" height="60" viewBox="0 0 1219.547 1225.016">
